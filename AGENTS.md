...
- **AI Financial Advisor runs in the regional cloud** and may **not** access CBS, Db2, ADABAS, or the ODS directly (FN-120). It receives only minimized, authorized data through the Advisor Context Service / data-minimization boundary.
